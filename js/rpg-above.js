...
function setmode(newmode, newgame){
    ...
    document.getElementById('page').innerHTML = '<div><div><a onclick="setmode(1, true)">Test Level</a></div></div><div class=right><div><input disabled value=Click>Cast Spell<br><input disabled value=ESC>Main Menu<br><input id=movement-keys maxlength=4 value='
