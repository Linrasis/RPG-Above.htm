...
function setmode(newmode, newgame){
    ...
    document.getElementById('page').innerHTML = '<div style=display:inline-block;text-align:left;vertical-align:top><div class=c><a onclick="setmode(1, true)">Test Level</a></div></div><div style="border-left:8px solid #222;display:inline-block;text-align:left"><div class=c><input disabled value=Click>Cast Spell<br><input disabled value=ESC>Main Menu<br><input id=movement-keys maxlength=4 value='
      + settings['movement-keys'] + '>Move ↑←↓→<br><input disabled value="0 - 9">Select Spell</div><hr><div class=c><input id=audio-volume max=1 min=0 step=.01 type=range value='
